...
def init():
    ...
    parser.add_argument("--show_fields", type=str, default="title,link,tag", help='Fields for printing (sep by ","; <empty> means all). (default: %(default)s)')
    a = parser.parse_args()
    # deal with them
    args = vars(a)
