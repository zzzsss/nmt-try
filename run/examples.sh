...
PYTHONPATH=${DY_ZROOT}/gbuild/python python3.5 ../znmt/test.py -t ../data2/en-fr/test.final.{en,fr.restore} -m zbest.model -o output.txt -n 1
...
bash ../znmt/scripts/restore.sh <output.txt | perl ../znmt/scripts/multi-bleu.perl -lc ../data2/en-fr/test.final.fr.restore
