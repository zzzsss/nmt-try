...
# x44
python3 ../../znmt/run/zprepare.py --zmt ../.. -d ../../zh_en_data/ -t znmt_zh --extras "gdrop_rec 0.2 idrop_embedding 0.0 drop_hidden 0.2 drop_embedding 0.2 lrate 0.0001 dicts ../../baselines/ze/{src,trg}.v reload_model_name ../../baselines/ze/zp1.m reload ZZ no_reload_training_progress ZZ no_rebuild_dicts ZZ valid_freq 5000 validate0 ZZ train_mode beam t2_beam_size 1 t2_sync_med ZZ t2_beam_loss err t2_bad_lambda 0.1 t2_bad_maxlen 2 t2_err_gold_mode based t2_err_seg_minlen 3 t2_err_mcov_thresh 0.25 t2_beam_nodrop ZZ" -z 6 -p 0
